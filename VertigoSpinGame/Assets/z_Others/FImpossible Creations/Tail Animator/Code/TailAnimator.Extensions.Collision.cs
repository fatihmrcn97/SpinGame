...
namespace FIMSpace.FTail
{
    public partial class TailAnimator2
    {
        ...
        public List<Collider> DynamicAlwaysInclude { get; private set; }
            ...
            if (CollisionSpace == ECollisionSpace.Selective_Fast)
            {
                ...
                for (int i = 0; i < IncludedCollidersData.Count; i++)
                {
                    ...
                    if (IncludedCollidersData[i].Collider.gameObject.activeInHierarchy)
                    {
                        ...
                        else // If we want to collide even with disabled colliders
        ...
        void AddColliders()
        {
            ...
            else
            {
                ...
                if (DynamicWorldCollidersInclusion)
                {
                    ...
                    //IncludedColliders.Clear();

                    //for (int i = 0; i < dynamicAlwaysInclude.Count; i++)
                    //    IncludedColliders.Add(dynamicAlwaysInclude[i]);
                    ...
                    SphereCollider triggerC = middleSegm.gameObject.AddComponent<SphereCollider>();
                    ...
                    float scale = Mathf.Abs(triggerC.transform.lossyScale.z);
