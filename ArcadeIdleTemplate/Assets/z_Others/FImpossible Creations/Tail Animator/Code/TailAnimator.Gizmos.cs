...
namespace FIMSpace.FTail
{
    public partial class TailAnimator2
    {
        ...
        public bool _editor_IsInspectorViewingSetup = true;
        public bool _editor_IsInspectorViewingShaping = true;
        public bool _editor_IsInspectorViewingColliders = true;
        public bool _editor_IsInspectorViewingModules = false;
        ...
        void OnDrawGizmosSelected()
        {
            ...
            if (Application.isPlaying)
            {
                ...
                if (_editor_IsInspectorViewingShaping || fDebug)
                {
            ...
            if (_editor_IsInspectorViewingSetup)
            {
            ...
            if (_editor_IsInspectorViewingColliders && _editor_IsInspectorViewingModules) Gizmos_DrawColliders();
        }
