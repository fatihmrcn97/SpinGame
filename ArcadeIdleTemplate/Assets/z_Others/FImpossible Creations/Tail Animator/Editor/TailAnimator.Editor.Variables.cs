...
namespace FIMSpace.FTail
{
    public partial class FTailAnimator2_Editor
    {
        ...
        protected virtual void OnEnable()
        {
            ...
            if (Get._TransformsGhostChain == null || Get._TransformsGhostChain.Count == 0)
            {
                drawTweaking = false;
                drawSetup = true;
            }
            ...
            if (!FEngineering.QIsZero(Get.RotationOffset) ||
                !FEngineering.QIsZero(Get.Curving) ||
                Get.LengthMultiplier != 1f ||
                !FEngineering.VIsZero(Get.Gravity))
                drawShaping = true;
            else
                drawShaping = false;
            ...
            if (Get.UseCollision) drawCollisions = false;
